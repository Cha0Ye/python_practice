...
This function takes in one parameter (a string) and returns a dictionary with the keys being the letters 
...
def multiple_letter_count(str):
    '''accepts string; returns dictionary with letters as keys and their counts as values'''
